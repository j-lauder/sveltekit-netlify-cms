      ...
      throw new Error(`Failed to serialize session data: ${error4.message}`);
				...
				hydrate: ${page_config.ssr && page_config.hydrate ? `{
					...
					page: {
						...
						path: ${page && page.path ? try_serialize(page.path, (error4) => {
      throw new Error(`Failed to serialize page.path: ${error4.message}`);
    }) : null},
						query: new URLSearchParams(${page && page.query ? s$1(page.query.toString()) : ""}),
						params: ${page && page.params ? try_serialize(page.params, (error4) => {
      throw new Error(`Failed to serialize page.params: ${error4.message}`);
    }) : null}
					}
				}` : "null"}
			});
...
var css = {
  ...
  map: `{"version":3,"file":"root.svelte","sources":["root.svelte"],"sourcesContent":["<!-- This file is generated by @sveltejs/kit \u2014 do not edit it! -->\\n<script>\\n\\timport { setContext, afterUpdate, onMount } from 'svelte';\\n\\n\\t// stores\\n\\texport let stores;\\n\\texport let page;\\n\\n\\texport let components;\\n\\texport let props_0 = null;\\n\\texport let props_1 = null;\\n\\texport let props_2 = null;\\n\\n\\tsetContext('__svelte__', stores);\\n\\n\\t$: stores.page.set(page);\\n\\tafterUpdate(stores.page.notify);\\n\\n\\tlet mounted = false;\\n\\tlet navigated = false;\\n\\tlet title = null;\\n\\n\\tonMount(() => {\\n\\t\\tconst unsubscribe = stores.page.subscribe(() => {\\n\\t\\t\\tif (mounted) {\\n\\t\\t\\t\\tnavigated = true;\\n\\t\\t\\t\\ttitle = document.title || 'untitled page';\\n\\t\\t\\t}\\n\\t\\t});\\n\\n\\t\\tmounted = true;\\n\\t\\treturn unsubscribe;\\n\\t});\\n<\/script>\\n\\n<svelte:component this={components[0]} {...(props_0 || {})}>\\n\\t{#if components[1]}\\n\\t\\t<svelte:component this={components[1]} {...(props_1 || {})}>\\n\\t\\t\\t{#if components[2]}\\n\\t\\t\\t\\t<svelte:component this={components[2]} {...(props_2 || {})}/>\\n\\t\\t\\t{/if}\\n\\t\\t</svelte:component>\\n\\t{/if}\\n</svelte:component>\\n\\n{#if mounted}\\n\\t<div id=\\"svelte-announcer\\" aria-live=\\"assertive\\" aria-atomic=\\"true\\">\\n\\t\\t{#if navigated}\\n\\t\\t\\t{title}\\n\\t\\t{/if}\\n\\t</div>\\n{/if}\\n\\n<style>\\n\\t#svelte-announcer {\\n\\t\\tposition: absolute;\\n\\t\\tleft: 0;\\n\\t\\ttop: 0;\\n\\t\\tclip: rect(0 0 0 0);\\n\\t\\tclip-path: inset(50%);\\n\\t\\toverflow: hidden;\\n\\t\\twhite-space: nowrap;\\n\\t\\twidth: 1px;\\n\\t\\theight: 1px;\\n\\t}\\n</style>"],"names":[],"mappings":"AAsDC,gCAAkB,CACjB,QAAQ,CAAE,QAAQ,CAClB,IAAI,CAAE,CAAC,CACP,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CACnB,SAAS,CAAE,MAAM,GAAG,CAAC,CACrB,QAAQ,CAAE,MAAM,CAChB,WAAW,CAAE,MAAM,CACnB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,GACT"}`
};
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-a9022a41.js",
      css: [assets + "/_app/assets/start-d5b4de3e.css"],
      js: [assets + "/_app/start-a9022a41.js", assets + "/_app/chunks/index-28f39e41.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": ".DS_Store", "size": 6148, "type": null }, { "file": "admin/config.yml", "size": 410, "type": "text/yaml" }, { "file": "admin/index.html", "size": 437, "type": "text/html" }, { "file": "favicon.png", "size": 1571, "type": "image/png" }],
  ...
  routes: [
    ...
    },
    {
      ...
      pattern: /^\/categories\/?$/,
      params: empty,
      a: [".svelte-kit/build/components/layout.svelte", "src/routes/categories.md"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
    ...
    },
    {
      ...
      pattern: /^\/game\/?$/,
      params: empty,
      a: [".svelte-kit/build/components/layout.svelte", "src/routes/game.md"],
      b: [".svelte-kit/build/components/error.svelte"]
    }
  ]
};
...
var module_lookup = {
  ...
  "src/routes/categories.md": () => Promise.resolve().then(function() {
    return __glob_0_0;
  }),
  "src/routes/contact.md": () => Promise.resolve().then(function() {
    return __glob_0_1;
  }),
  "src/routes/game.md": () => Promise.resolve().then(function() {
    return __glob_0_2;
  })
};
var metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "layout.svelte-d20c9d5a.js", "css": [], "js": ["layout.svelte-d20c9d5a.js", "chunks/index-28f39e41.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-603ec8ac.js", "css": [], "js": ["error.svelte-603ec8ac.js", "chunks/index-28f39e41.js"], "styles": [] }, "src/routes/index.md": { "entry": "pages/index.md-6b4aa6e0.js", "css": ["assets/index-44c99173.css"], "js": ["pages/index.md-6b4aa6e0.js", "chunks/index-28f39e41.js", "chunks/index-d527be41.js"], "styles": [] }, "src/routes/categories.md": { "entry": "pages/categories.md-1a90f5a3.js", "css": ["assets/index-44c99173.css"], "js": ["pages/categories.md-1a90f5a3.js", "chunks/index-28f39e41.js", "chunks/index-d527be41.js"], "styles": [] }, "src/routes/contact.md": { "entry": "pages/contact.md-ac472e08.js", "css": ["assets/index-44c99173.css"], "js": ["pages/contact.md-ac472e08.js", "chunks/index-28f39e41.js", "chunks/index-d527be41.js"], "styles": [] }, "src/routes/game.md": { "entry": "pages/game.md-f8c05991.js", "css": ["assets/index-44c99173.css"], "js": ["pages/game.md-f8c05991.js", "chunks/index-28f39e41.js", "chunks/index-d527be41.js"], "styles": [] } };
...
var error2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": Error$1,
  load
}, Symbol.toStringTag, { value: "Module" }));
...
var Categories = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Default, "Layout_MDSVEX_DEFAULT").$$render($$result, Object.assign({}, $$props, metadata$3), {}, {
    default: () => {
      return `<p>G\uFEFFame categories</p>
<ul><li>Action</li>
<li>Adventure</li>
<li>Role-playing</li>
...
<li>Massively multiplayer online role-playing game (MMORPG)</li>
...
<li>Educational</li>
<li>Music and rhythm</li>
<li>Shoot \u2018em up</li>
<li>Visual novel</li>
<li>Dating sim</li>
<li>Stealth-based action-adventure</li>
<li>Roguelike</li>
<li>Roguelite</li>
<li>Artillery</li>
<li>Racing simulation</li>
<li>Team-based shooter</li>
<li>Historical</li>
<li>Space exploration</li>
<li>Tactical role-playing game (Tactical RPG)</li>
<li>Real-time tactics (RTT)</li>
<li>Interactive drama</li>
<li>City-building</li>
<li>Puzzle-platformer</li>
<li>Fighting games (2D)</li>
<li>Dance</li>
...
<li>God game</li>
<li>4X (eXplore, eXpand, eXploit, and eXterminate)</li>
<li>Massively multiplayer online (MMO)</li>
<li>Trivia</li>
<li>Tower offense</li>
<li>Life simulation</li>
<li>Arcade</li>
<li>Historical strategy</li>
<li>Platform-adventure</li>
<li>Tactical RPG shooter</li>
<li>Racing RPG</li>
<li>Wrestling</li>
<li>Farming simulation</li>
<li>Visual storytelling</li>
<li>Compilation</li>
<li>Action role-playing game (ARPG)</li>
<li>Real-time tactics role-playing game (RTT-RPG)</li>
<li>Isometric RPG</li>
<li>Stealth-based shooter</li>
<li>Narrative-driven</li>
<li>Tower building</li>
<li>Deck-building</li>
<li>Espionage</li>
<li>Third-person shooter (TPS)</li>
<li>Wargame</li>
<li>Cooking simulation</li>
<li>Puzzle-adventure</li>
<li>Educational simulation</li>
<li>Isometric action-adventure</li>
<li>Multiplayer online battle royale</li>
<li>Collectible card game (CCG)</li>
<li>Survival horror</li>
<li>Non-violent</li>
<li>Dungeon crawler</li>
<li>Tower defense strategy</li>
<li>Racing RPG shooter</li>
<li>Tactical shooter RPG</li>
<li>Party games</li>
<li>Real-time tactics shooter</li>
<li>Real-time strategy role-playing game (RTS-RPG)</li>
<li>Hack and slash</li>
<li>Text-based</li>
<li>Battle card game</li>
<li>Tactical puzzle</li>
<li>Space combat</li>
<li>Exergaming</li>
<li>Real-time strategy tactics</li>
<li>Real-time strategy shooter</li></ul>`;
    }
  })}`;
});
...
var Contact = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Default, "Layout_MDSVEX_DEFAULT").$$render($$result, Object.assign({}, $$props, metadata$2), {}, {
    default: () => {
      return `<p>Have a question or comment? We would love to hear from you. Please reach out using the contact form below:</p>`;
    }
  })}`;
});
...
var metadata$1 = { "title": "Game", "nav_label": "game" };
var Game = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Default, "Layout_MDSVEX_DEFAULT").$$render($$result, Object.assign({}, $$props, metadata$1), {}, {
    default: () => {
      return `<p><img src="https://images.igdb.com/igdb/image/upload/t_cover_big/co5vmg.png" alt="The Legend of Zelda" title="The Legend of Zelda"></p>
<p>T\uFEFFhis is The Legend of Zelda</p>
<p><a href="https://images.igdb.com/igdb/image/upload/t_cover_big/co5vmg.png" rel="nofollow">https://images.igdb.com/igdb/image/upload/t_cover_big/co5vmg.png</a></p>`;
    }
  })}`;
});
...
var modules = Object.entries({ "./routes/categories.md": __glob_0_0, "./routes/contact.md": __glob_0_1, "./routes/game.md": __glob_0_2, "./routes/index.md": __glob_0_3 });
var getRoutes = () => {
...
var Default = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-1az6e94_START -->${$$result.title = `<title>${escape2(title)}</title>`, ""}<!-- HEAD_svelte-1az6e94_END -->`, ""}

<nav><ul>${each(routes, (route) => {
    return `<li><a${add_attribute("href", route.path, 0)}>${escape2(route.title)}</a>
			</li>`;
  })}</ul></nav>
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Default, "Layout_MDSVEX_DEFAULT").$$render($$result, Object.assign({}, $$props, metadata), {}, {
    default: () => {
      return `<h1>Welcome to GameZerg</h1>
<p>Y\uFEFFour source for video games, reviews, news, tools, gear, and more.</p>`;
    }
  })}`;
});
